...
<p align="center">
  <a href="https://iemek.org/Conference/ConferenceView.asp?top_param=4&sub_param=1&AC=0&CODE=CC20250901&CpPage=665#CONF">
    <img src="https://img.shields.io/badge/Award-2025_IEMEK_Best_Presentation-FFD700?style=for-the-badge&logo=trophy&logoColor=black" alt="Best Presentation Award Badge" />
  </a>
</p>
...
- **공식 azena MQTT 표준 문법 기반 서비스 제공**  
  ...
  다른 개발자도 동일한 문법으로 손쉽게 azena 생태계 시스템 사용이 가능합니다.

- **안드로이드 기반 독립 실행형 메시징 허브**  
  하나의 Android 앱 안에서 MQTT 서비스를 모두 실행할 수 있는 독립형 허브를 구현했습니다.  
...
- **Gateway를 통한 uplink/downlink 토픽 패턴 관리**  
  Gateway 역할을 통해 업링크/다운링크 토픽을 일관성 있게 관리하고, 안드로이드 업데이트 및 확장 가능한 토픽 패턴 설계를 지원합니다.
